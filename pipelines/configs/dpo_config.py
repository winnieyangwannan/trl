...
class DPOConfig(TrainingArguments):
    ...
    per_device_train_batch_size: int = 1 # 32 for LoRA # 16 for full # Set according to your GPU memory capacity
    per_device_eval_batch_size: int = 1 # 32 for LoRA  # 16 for full # Set according to your GPU memory capacity
    per_device_test_batch_size: int = 1 #32 for LoRA  # 16 for full # Set according to your GPU memory capacity
    bf16 = True
    logging_steps = 100
